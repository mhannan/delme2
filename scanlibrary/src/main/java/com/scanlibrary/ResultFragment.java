...
public class ResultFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        analyticsClass.sendScreenAnalytics(getActivity(), "Scan Done Fragment");
...
//                                        @Override
//                                        public void run() {
//                                            Utils.progressBar.setProgress(progressStatus[0]);
//                                        }
//                                    });
                    ...
                    try {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                analyticsClass.sendEventAnalytics("scan done action", "done");
                            }
                        });
                    } catch (Exception e) {
                        e.printStackTrace();
