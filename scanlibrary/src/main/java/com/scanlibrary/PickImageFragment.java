 ...
 */
public class PickImageFragment extends Fragment implements FragmentBackPress {
    ...
    public void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                    "com.pdf.reader.pdfviewer.pdfbookreader.readpdf.fileprovider", // As defined in Manifest
                    file);
